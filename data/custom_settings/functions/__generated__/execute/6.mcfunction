...
execute as @e[type=armor_stand, tag=blkh_finder, tag=block] at @s run tp @s ~ ~ ~ facing entity @e[limit=1, type=armor_stand, tag=blkh_blackhole, sort=nearest]
...
execute as @e[type=armor_stand, tag=blkh_finder, tag=lava] at @s run tp @s ~ ~ ~ facing entity @e[limit=1, type=armor_stand, tag=blkh_blackhole, sort=nearest]
...
execute as @e[type=armor_stand, tag=blkh_finder, tag=water] at @s run tp @s ~ ~ ~ facing entity @e[limit=1, type=armor_stand, tag=blkh_blackhole, sort=nearest]
...
execute as @e[type=armor_stand, tag=blkh_finder, tag=inverted] at @s run tp @s ~ ~ ~ facing entity @e[limit=1, type=armor_stand, tag=blkh_blackhole, sort=nearest]
...
execute as @e[type=armor_stand, tag=blkh_finder, tag=life] at @s run tp @s ~ ~ ~ facing entity @e[limit=1, type=armor_stand, tag=blkh_blackhole, sort=nearest]